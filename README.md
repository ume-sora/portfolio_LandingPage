...
**Landing Page（ヒーローセクション）**

ヘッダー・キャッチコピー・CTA ボタン（Primary / Outline）の構成例です。

![Landing Page - ヒーローセクション](./assets/landing-page-hero.png)

**UI Components Showcase（Button コンポーネント）**

variant（Primary, Secondary, Outline, Ghost, Danger, Light）と size（Small, Medium, Large）の一覧です。

![UI Showcase - Button コンポーネント](./assets/ui-showcase-button.png)
